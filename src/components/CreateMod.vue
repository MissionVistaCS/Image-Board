<template>
    <div class="createMod">
        <div class="boardBanner">
            <div class="boardTitle">Image Board Create Mod</div>
        </div>
        <hr style="width: 90%">
        <br>
            ...
            <table class="postForm">
                ...
                <tr>
                    <td colspan="2"
                        ...
                        <input value="Submit" style="margin: 0px;" type="button" v-on:click="createMod">
                    </td>
                </tr>
                </tbody>
...
<script>
    export default {
        ...
        methods: {
            createMod() {
                let vm = this;
                _api.createMod(this.username, this.password, function (err, res) {
                    if (err) {
                        vm.error = err;
                    }
                    else if (res.result) {
